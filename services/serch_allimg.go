...
func GetImagesByTags(userID uint, tagNames []string, enablePaging bool, page, pageSize int, order string) (*ImageResult, error) {
	db := models.GetDB()
	return dao.GetImagesByTags(db, userID, tagNames, enablePaging, page, pageSize, order)
}
